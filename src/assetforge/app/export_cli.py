...
from assetforge.models.export_dto import export_report_to_dict


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export a Blender vehicle asset to FBX.")
...
def main() -> int:
    ...
    try:
        report = services.vehicle_export.export_fbx(args.blend_file, args.profile)
