...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run safe Limited Dissolve preprocess.")
...
def main() -> int:
    ...
    try:
        report = services.preprocess.preprocess(args.blend_file, args.angle_degrees)
