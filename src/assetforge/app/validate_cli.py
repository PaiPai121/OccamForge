...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate a Blender vehicle asset.")
...
def main() -> int:
    ...
    try:
        report = services.vehicle_validation.validate_vehicle(args.blend_file, args.profile)
